...
describe('AuthService', () => {
  ...
  describe('refreshTokens', () => {
    ...
    it('should refresh tokens successfully', async () => {
      ...
      mockPrismaService.session.create.mockResolvedValue({ id: 'new-session-id' });
  ...
  describe('decryptCredentials', () => {
    it('should decrypt credentials', () => {
      ...
      expect(mockCryptoService.decrypt).toHaveBeenCalledWith('encrypted-rollno');
      expect(mockCryptoService.decrypt).toHaveBeenCalledWith('encrypted-password');
